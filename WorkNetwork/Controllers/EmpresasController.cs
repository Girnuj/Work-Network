...
namespace WorkNetwork.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("idEmpresa,razonSocial,CUIT,numeroDeDocumento,email,idLocalidad,telefono1,telefono2,idRubro")] Empresa empresa)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("idEmpresa,razonSocial,CUIT,numeroDeDocumento,email,idLocalidad,telefono1,telefono2,idRubro")] Empresa empresa)
        //{
